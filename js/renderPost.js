...
async function fetchAndRenderPostWithComments() {
    ...
    `;
		...
		const comments = postDetails._embedded?.replies ? postDetails._embedded.replies[0] : [];
      ...
      `;
		...
		document.getElementById("commentsContainer").innerHTML = "<p>Failed to load comments.</p>";
	}
}
